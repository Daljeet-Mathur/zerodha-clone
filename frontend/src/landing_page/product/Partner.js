        ...
        <div className='container partner'>
            ...
            <div className='row text-center'>
                <div className='col-4 parnter-body'>
                    <a href='/'>
                        <img src='images\images\zerodhaFundhouse.png' />
                ...
                <div className='col-4 parnter-body'>
                    <a href='/'>
                        <img src='images\images\sensibullLogo.svg' style={{height:"40px"}} />
                ...
                <div className='col-4 parnter-body'>
                    <a href='/'>
                        <img src='images\images\tijori.svg' />
                ...
                <div className='col-4 parnter-body'>
                    <a href='/'>
                        <img src='images\images\streakLogo.png' />
                ...
                <div className='col-4 parnter-body'>
                    <a href='/'>
                        <img src='images\images\dittoLogo.png' />
